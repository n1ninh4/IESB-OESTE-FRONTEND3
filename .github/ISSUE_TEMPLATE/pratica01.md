...
```bash
git add .
git commit -m "o nome que você definir"
```
...
6. Na descrição, escreva: `Nesta prática, implementei a estrutura básica de um programa em ReactJS. Fecha #ID`.
